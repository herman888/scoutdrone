...
class TenantResponse(BaseModel):
    ...
    profile_image_url: str | None = None  # Tenant avatar/profile image
    emergency_contacts: list[dict[str, Any]] = []
    ...
    # Rent payment transactions (from new Stripe Connect system)
    rent_payment_transactions: list[RentPaymentTransactionResponse] = []
